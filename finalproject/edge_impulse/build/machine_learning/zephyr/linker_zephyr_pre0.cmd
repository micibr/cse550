...
bt_le_adv_prov_ad_area : SUBALIGN(4) { _bt_le_adv_prov_ad_list_start = .; KEEP(*(SORT_BY_NAME(._bt_le_adv_prov_ad.static.*))); _bt_le_adv_prov_ad_list_end = .; } > FLASH
bt_le_adv_prov_sd_area : SUBALIGN(4) { _bt_le_adv_prov_sd_list_start = .; KEEP(*(SORT_BY_NAME(._bt_le_adv_prov_sd.static.*))); _bt_le_adv_prov_sd_list_end = .; } > FLASH
module_id_list_all :
{
