...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_SENSOR_EVENT_DESCR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_SENSOR_SLEEP_TO, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_EI_DATA_FORWARDER_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_INIT_LOG_EI_DATA_FORWARDER_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_ML_RESULT_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_INIT_LOG_ML_RESULT_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_MODE_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_INIT_LOG_ML_APP_MODE_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_SENSOR_SIM_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_INIT_LOG_SENSOR_SIM_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_EI_DATA_FORWARDER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_EI_DATA_FORWARDER_UART, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_EI_DATA_FORWARDER_SENSOR_EVENT_DESCR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_EI_DATA_FORWARDER_BUF_SIZE, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_EI_DATA_FORWARDER_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_EI_DATA_FORWARDER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_LED_STATE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_LED_STATE_ANOMALY_THRESH, 500);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_LED_STATE_VALUE_THRESH, 900);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_LED_STATE_PREDICTION_STREAK_THRESH, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_LED_STATE_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_LED_STATE_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_MODE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_MODE_CONTROL_BUTTON_ID, 0x0000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_MODE_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_MODE_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_ML_RUNNER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_ML_RUNNER_SENSOR_EVENT_DESCR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_ML_RUNNER_WINDOW_SHIFT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_ML_RUNNER_FRAME_SHIFT, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_ML_RUNNER_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_ML_RUNNER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_USB_STATE_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_USB_STATE_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_SENSOR_SIM_CTRL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_SENSOR_SIM_CTRL_TRIG_BUTTON, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_SENSOR_SIM_CTRL_TRIG_BUTTON_ID, 0x0002);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_SENSOR_SIM_CTRL_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_SENSOR_SIM_CTRL_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_EI_RESULT_NSMS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_EI_RESULT_SECURITY_LEVEL_NONE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ML_APP_EI_RESULT_SECURITY_LEVEL, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ADV_PROV_FLAGS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ADV_PROV_DEVICE_NAME, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ISR_STACK_SIZE, 1536);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_SENSOR_SIM_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RX_STACK_SIZE, 2000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ADV_PROV, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ADV_PROV_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ADV_PROV_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ADV_PROV_DEVICE_NAME_PAIRING_MODE_ONLY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ADV_PROV_DEVICE_NAME_SD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_NRF_SERVICES, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_NSMS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_NSMS_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_NSMS_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_LATENCY, 99);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_EVENT_MANAGER_REBOOT_ON_EVENT_ALLOC_FAIL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_PM_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_POWER_DOWN_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_POWER_OFF_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_WAKE_UP_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_COMMON_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_BLE_PEER_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_BLE_PEER_SEARCH_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_BLE_ADV_DATA_UPDATE_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_BLE_PEER_OPERATION_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_BLE_PEER_CONN_PARAMS_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_SMP_TRANSFER_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BUTTON_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_BUTTON_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_CLICK_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_CLICK_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_LED_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_LED_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_LED_READY_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_KEEP_ALIVE_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_KEEP_ALIVE_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_MODULE_STATE_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_MODULE_STATE_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_MODULES_FLAGS_COUNT, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_POWER_MANAGER_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_POWER_MANAGER_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_SENSOR_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_INIT_LOG_SENSOR_STATE_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV_PM_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV_FAST_ADV, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV_SLOW_INT_MIN, 0x00a0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV_SLOW_INT_MAX, 0x00f0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV_FAST_INT_MIN, 0x0030);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV_FAST_INT_MAX, 0x0060);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV_FAST_ADV_TIMEOUT, 30);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV_ROTATE_RPA_TIMEOUT, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV_ROTATE_RPA_TIMEOUT_RAND, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV_BLE_BOND_SUPPORTED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_ADV_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_BOND, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_BOND_PEER_ERASE_CLICK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_BOND_PEER_ERASE_CLICK_KEY_ID, 0x0000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_BOND_PEER_ERASE_CLICK_TIMEOUT, 3000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_BOND_PEER_ERASE_CLICK_DOUBLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_BOND_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_BOND_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_BOND_SUPPORTED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_SMP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_SMP_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_SMP_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_STATE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_STATE_MAX_LOCAL_ID_BONDS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_STATE_PM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_STATE_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BLE_STATE_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BUTTONS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BUTTONS_DEF_PATH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BUTTONS_PM_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BUTTONS_PM_KEEP_ALIVE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BUTTONS_SCAN_INTERVAL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BUTTONS_DEBOUNCE_INTERVAL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BUTTONS_POLARITY_INVERSED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BUTTONS_EVENT_LIMIT, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BUTTONS_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_BUTTONS_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_CLICK_DETECTOR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_CLICK_DETECTOR_DEF_PATH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_CLICK_DETECTOR_LONG_CLICK_MSEC, 5000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_CLICK_DETECTOR_SHORT_CLICK_MSEC, 500);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_CLICK_DETECTOR_PM_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_CLICK_DETECTOR_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_CLICK_DETECTOR_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_LEDS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_LEDS_PWM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_LEDS_PM_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_LEDS_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_LEDS_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_POWER_MANAGER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_POWER_MANAGER_TIMEOUT, 120);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_POWER_MANAGER_ERROR_TIMEOUT, 30);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_POWER_MANAGER_CLEAR_RESET_REASON, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_POWER_MANAGER_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_POWER_MANAGER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_SENSOR_MANAGER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_SENSOR_MANAGER_PM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_SENSOR_MANAGER_ACTIVE_PM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_SENSOR_MANAGER_DEF_PATH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_SENSOR_MANAGER_THREAD_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_SENSOR_MANAGER_THREAD_PRIORITY, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_SENSOR_MANAGER_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_SENSOR_MANAGER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_SETTINGS_LOADER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_SETTINGS_LOADER_DEF_PATH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_SETTINGS_LOADER_THREAD_STACK_SIZE, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_SETTINGS_LOADER_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAF_SETTINGS_LOADER_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WAVE_GEN_LIB_LOG_LEVEL_DEFAULT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_COOP_PRIORITIES, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_PREEMPT_PRIORITIES, 11);
